...
public class HyPeerWeb {
	...
	/**
	 * @param i The index (WebID value) of the node to get
	 ...
	 * @post All prievious nodes are removed and all nodes from the database are added
	 */
	public void reload() {
	 ...
	 * @param dbName The name of the database file to load from
	 * @post All prievious nodes are removed and all nodes from the database are added
	 */
	 ...
	 * @post Prievious database information is replaced with the current state of the HyPeerWeb
	 */
